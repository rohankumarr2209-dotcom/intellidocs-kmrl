...
const translations: Translations = {
  en: {
    ...
    'dashboard.documentsWeek': 'Documents This Week',
    'dashboard.timeSaved': 'Processing Time Saved',
    'dashboard.complianceRate': 'Compliance Rate',
    'dashboard.urgentActions': 'Urgent Actions',
    'dashboard.quickUpload': 'Quick Document Upload',
    'dashboard.uploadDesc': 'Drag and drop your documents for instant AI processing and summarization',
    'dashboard.dropFiles': 'Drop files here or click to upload',
    'dashboard.supportedFormats': 'Supports PDF, Word, Excel, PowerPoint, and image files',
    'dashboard.chooseFiles': 'Choose Files',
    'dashboard.todaySummaries': 'Today\'s AI Summaries',
    'dashboard.latestProcessed': 'Latest processed documents with AI insights',
    'dashboard.pendingActions': 'Pending Actions',
    'dashboard.urgentTasks': 'Urgent tasks and upcoming deadlines',
    'dashboard.recentAlerts': 'Recent Alerts',
    'dashboard.weeklyAnalytics': 'Weekly Analytics',
    'dashboard.processingEfficiency': 'Processing Efficiency',
  ...
  ml: {
    ...
    'dashboard.subtitle': 'ഇന്ന് നിങ്ങളുടെ ഡോക്യുമെന്റുകളിൽ എന്താണ് സംഭവിക്കുന്നത്.',
    'dashboard.documentsWeek': 'ഈ ആഴ്ചയിലെ ഡോക്യുമെന്റുകൾ',
    'dashboard.timeSaved': 'പ്രോസസിംഗ് സമയം ലാഭിച്ചു',
    'dashboard.complianceRate': 'കംപ്ലയൻസ് നിരക്ക്',
    'dashboard.urgentActions': 'അടിയന്തിര നടപടികൾ',
    'dashboard.quickUpload': 'ദ്രുത ഡോക്യുമെന്റ് അപ്‌ലോഡ്',
    'dashboard.uploadDesc': 'തൽക്ഷണ AI പ്രോസസിംഗിനും സംഗ്രഹത്തിനുമായി നിങ്ങളുടെ ഡോക്യുമെന്റുകൾ ഡ്രാഗ് ചെയ്ത് ഡ്രോപ്പ് ചെയ്യുക',
    'dashboard.dropFiles': 'ഫയലുകൾ ഇവിടെ ഇടുക അല്ലെങ്കിൽ അപ്‌ലോഡ് ചെയ്യാൻ ക്ലിക്ക് ചെയ്യുക',
    'dashboard.supportedFormats': 'PDF, Word, Excel, PowerPoint, ഇമേജ് ഫയലുകൾ പിന്തുണയ്ക്കുന്നു',
    'dashboard.chooseFiles': 'ഫയലുകൾ തിരഞ്ഞെടുക്കുക',
    'dashboard.todaySummaries': 'ഇന്നത്തെ AI സംഗ്രഹങ്ങൾ',
    'dashboard.latestProcessed': 'AI ഇൻസൈറ്റുകളോടൊപ്പം ഏറ്റവും പുതിയ പ്രോസസ്സ് ചെയ്ത ഡോക്യുമെന്റുകൾ',
    'dashboard.pendingActions': 'തീർപ്പാക്കാത്ത നടപടികൾ',
    'dashboard.urgentTasks': 'അടിയന്തിര ജോലികളും വരാനിരിക്കുന്ന സമയപരിധിയും',
    'dashboard.recentAlerts': 'സമീപകാല അലേർട്ടുകൾ',
    'dashboard.weeklyAnalytics': 'പ്രതിവാര അനലിറ്റിക്സ്',
    'dashboard.processingEfficiency': 'പ്രോസസിംഗ് കാര്യക്ഷമത',
    'dashboard.complianceScore': 'കംപ്ലയൻസ് സ്കോർ',
    'dashboard.responseTime': 'പ്രതികരണ സമയം',
    'dashboard.viewFullReport': 'പൂർണ്ണ റിപ്പോർട്ട് കാണുക',
